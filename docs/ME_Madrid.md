...
Bienvenidos al ME-FERTILE en la Comunidad de Madrid.

Este curso tiene una duración estimada de 20h: 14 en línea y 6 presenciales. Constará de dos sesiones presenciales, dos sesiones online y trabajo personal de estudio asíncrono.  Usaréis y aprenderéis tecnologías docentes punteras y equipamiento educativo, tanto robots simulados como robots físicos. 
...
### Familiarización con algunos materiales de robótica educativa. Primeros pasos en la creación de un proyecto de arte y robótica

####Taller de trabajo con distintos materiales de robótica. 

En este taller se dará una visión general de diferentes materiales de robótica educativa, centrándonos en Microbit tanto aislado como en su uso conjunto con Nehza, Arduino, True-True y Makey-Makey. Los participantes trabajarán con los materiales con una propuesta de actividades como guía:
...
El taller online síncrono de 1h de duración para trabajar de manera práctica con varios simuladores robóticos, en concreto usaremos: MakeCode de Microbit, TinkerCad para Arduino y Kibotics. Os os haremos llegar un enlace para la sesión.
...
## 6. Sesión online (2) (Fecha por determinar)

Esta sesión será un Webminar sobra la metodología FERTILE con el objetivo de que los participantes conozcáis y os familiaricéis con la metodología. Para ello emplearemos:
...
## 7. Sesión presencial (2) (Fecha y lugar por dererminar)
